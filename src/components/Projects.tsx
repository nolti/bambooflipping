      ...
      <section id="projects" className="py-12 bg-surfacelight dark:bg-onsecondary">
        <div className="container">
          <div className="flex flex-col items-start mb-2">
            <h2 className="text-3xl md:text-3xl font-bold mb-1 text-lightprimary dark:text-draculacianlight">
              Nuestros Proyectos
            </h2>
            <p className="text-lightsubtitle dark:text-draculacianlightgrey mb-4 text-lg">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              ...
              >
                ...
                <h3 className="mt-4 text-xl font-semibold text-lightprimary dark:text-draculacianlight">{project.title}</h3>
                <p className="text-lightsubtitle dark:text-lightsubtitle">Desliza para ver el cambio</p>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <AnimatePresence>
          {selectedProject !== null && (
            ...
            >
              ...
              <div className="p-6">
                <h2 className="text-2xl font-medium mb-4 text-lightprimary dark:text-draculacianlight">
