...
export const StrategyForm = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-surface relative">
      ...
      <button
        onClick={() => navigate('/')}
        className="fixed bottom-6 left-6 z-50 bg-lightbutton text-lightbuttontext px-4 py-2 rounded-lg font-medium hover:bg-lightbutton/90 transition-colors duration-300 transform hover:scale-105 active:scale-100 dark:bg-primary dark:text-dark dark:hover:bg-primary/90 flex items-center gap-2 shadow-lg"
      >
        <ArrowLeft size={20} />
