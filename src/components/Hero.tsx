...
export const Hero = () => {
  ...
  return (
    <section className="relative h-[62.5vh] flex items-center pt-16">
      ...
      <div className="container relative z-10">
        ...
        <div>
          <div className="max-w-lg">
            <h1 className="text-3xl sm:text-4xl md:text-4xl font-semibold mt-4 mb-3">
              Transformamos propiedades en sueños rentables!
            </h1>
          </div>
          <div className="max-w-sm">
          <p className="text-2xl sm:text-2xl md:text-2xl mb-6 text-secondary">
            ¿Querés renovar para vender o alquilar rápidamente?
            <br />Somos tu solución!
          </p>
          </div>
          <button onClick={() => navigate('/estrategia')}className="btn-primary inline-block">
            Estrategia GRATIS!
          </button>
        </div>
      </div>
